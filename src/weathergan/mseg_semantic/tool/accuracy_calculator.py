...
from weathergan.mseg_semantic.utils.img_path_utils import get_unique_stem_from_last_k_strs
from weathergan.mseg_semantic.utils.transform import ToUniversalLabel
