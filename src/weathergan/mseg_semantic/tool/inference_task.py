...
from weathergan.mseg_semantic.utils.img_path_utils import dump_relpath_txt, get_unique_stem_from_last_k_strs
from weathergan.mseg_semantic.tool.mseg_dataloaders import create_test_loader
from weathergan.mseg_semantic.utils.logger_utils import get_logger
...
class InferenceTask:
    ...
    def load_model(self, args) -> nn.Module:
        ...
        if args.arch == "psp":
            ...
            from weathergan.mseg_semantic.model.seg_hrnet import get_configured_hrnet
            ...
            from weathergan.mseg_semantic.model.seg_hrnet import get_configured_hrnet
            from weathergan.mseg_semantic.model.seg_hrnet_ocr import get_configured_hrnet_ocr
